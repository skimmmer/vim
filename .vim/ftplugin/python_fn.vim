...
map  <silent> <leader>cc   :call PythonCommentSelection()<CR>
vmap <silent> <leader>cc   :call PythonCommentSelection()<CR>
map  <silent> <leader>co   :call PythonUncommentSelection()<CR>
vmap <silent> <leader>co  :call PythonUncommentSelection()<CR>
